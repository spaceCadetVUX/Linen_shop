...
@section('title', ($category->name ?? 'Bộ sưu tập') . ' — LINNÉ')
...
{{-- ============================================================
     CATEGORY BANNER
     Split layout: image col left + text col right.
     Different from shop/index which uses full-bleed overlay.
     Replace: $category->banner_image, $category->name,
              $category->description, $products->total()
     ============================================================ --}}
<section class="plp-banner">
  <div class="plp-banner-img-col">
    <img
      src="https://elleandriley.com/cdn/shop/files/Cashmere_Crew_Camel3.jpg?v=1779070696&width=2400"
      alt="Áo Linen — LINNÉ"
  ...
  <div class="plp-banner-info">
    ...
    <h1 class="plp-banner-title">Áo Linen</h1>
    <div class="plp-banner-divider"></div>
    <p class="plp-banner-desc">Những thiết kế linen tinh tế — dệt từ sợi tự nhiên, định hình vẻ đẹp giản dị mà sang trọng cho mùa Thu.</p>
    <p class="plp-banner-sub">18 sản phẩm</p>
  </div>
</section>
...
<div class="plp-toolbar-wrap">
  <div class="plp-toolbar">
    ...
    <div class="plp-toolbar-right">
      <span class="plp-count" id="plpCount">18 sản phẩm</span>
