...
class ReviewService
{
    ...
    /**
     * Create a pending review for a product. Always is_approved = false —
     * only an admin approval in Filament makes it public / counted in
     * the AggregateRating JSON-LD (see ReviewObserver).
     *
     * @param  UploadedFile[]  $images
     */
    public function submit(Product $product, string $userId, string $authorName, array $data, array $images = []): Review
    {
        /** @var Review $review */
