...
- **Slug** (đường dẫn URL) sẽ **tự sinh theo tên tiếng Việt** khi bạn gõ tên — có thể sửa tay nếu muốn đường dẫn khác.
  - ⚠️ Nếu sau này bạn đổi lại **Tên tiếng Anh**, slug tiếng Anh **sẽ không tự cập nhật lại** nếu đã có sẵn — cần tự sửa tay slug nếu muốn đồng bộ.
...
Khi mở form lần đầu, hệ thống **tự động điền sẵn** 1 lần: Tiêu đề SEO ← Tên sản phẩm, Mô tả SEO ← Mô tả ngắn, ảnh chia sẻ (og_image) ← ảnh đầu tiên trong tab Images.
