...
| Ảnh chia sẻ riêng từng Sản phẩm/Danh mục | *(tự động lấy từ ảnh sản phẩm/danh mục đã upload)* | *(không có)* | *(không có)* |
...
| Media Library | (không áp dụng) | Ảnh/Video/PDF | **20MB** |
