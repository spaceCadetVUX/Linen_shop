        ...
        $products = [
            [
                'product' => [
                    ...
                    'description'       => 'Áo Tank Cashmere Lurex CacyLinen được dệt từ 90% cashmere Mông Cổ Grade A và 10% sợi lurex ánh kim, mang lại vẻ sang trọng tinh tế cho mọi trang phục. Dáng fitted tôn dáng, chất liệu mềm mại, nhẹ và ấm.',
                    'price'             => 2890000,
                    'currency'          => 'VND',
                    'stock_quantity'    => 25,
                    'is_active'         => true,
                ...
                'trans_en' => [
                    ...
                    'description'        => 'The CacyLinen Cashmere Lurex Tank Top is woven from 90% Grade A Mongolian cashmere and 10% metallic lurex yarn, delivering subtle luxury for any outfit. Fitted silhouette, soft, lightweight and warm.',
                    'price'              => null,
                    'currency'           => null,
                ],
            ],
            [
                'product' => [
                    ...
                    'description'       => 'Áo Len Cashmere Cổ Tròn CacyLinen dệt 100% cashmere nguyên chất, form basic thanh lịch, dễ dàng phối cùng quần âu hoặc chân váy. Giữ ấm tốt, thoáng khí, không gây bí da.',
                    'price'             => 3490000,
                    'currency'          => 'VND',
                    'stock_quantity'    => 18,
                    'is_active'         => true,
                ...
                'trans_en' => [
                    ...
                    'description'        => 'The CacyLinen Crewneck Cashmere Sweater is woven from 100% pure cashmere in an elegant basic silhouette, easy to pair with trousers or skirts. Warm, breathable, and gentle on skin.',
                    'price'              => null,
                    'currency'           => null,
                ],
            ],
            [
                'product' => [
                    ...
                    'description'       => 'Khăn Choàng Cashmere CacyLinen dệt từ sợi cashmere cao cấp, kích thước 70x200cm, mềm mại và ấm áp, phù hợp làm phụ kiện cho cả nam và nữ trong mùa lạnh.',
                    'price'             => 1590000,
                    'currency'          => 'VND',
                    'stock_quantity'    => 40,
                    'is_active'         => true,
                ...
                'trans_en' => [
                    ...
                    'description'        => 'The CacyLinen Cashmere Scarf is woven from premium cashmere yarn, 70x200cm, soft and warm — a versatile accessory for both men and women in cold weather.',
                    'price'              => null,
                    'currency'           => null,
                ],
            ],
